                ...
                React.createElement("div", { ref: pluginResize.secondRef, style: { minWidth: 0 } },
                    React.createElement("div", { className: "graphiql-sessions" },
                        React.createElement("div", { className: "graphiql-session-header" },
                            React.createElement(Tabs, { values: editorContext.tabs, onReorder: handleReorder, "aria-label": "Select active operation" }, editorContext.tabs.length > 1 ? (React.createElement(React.Fragment, null,
                            ...
                            React.createElement("div", { className: "graphiql-session-header-right" },
                                editorContext.tabs.length === 1 ? (React.createElement("div", { className: "graphiql-add-tab-wrapper" }, addTab)) : null,
                                logo)),
